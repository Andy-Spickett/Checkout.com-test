namespace Checkout
{
    public class ApiUrls
    {
        ...
        {
            get { return _drinksApiUri ?? (_drinksApiUri = string.Concat(AppSettings.BaseApiUri, "/drinks")); }
        }
        ...
        public static string Drink
        {
            get
            {
                return _drinksApiUri ?? (_customerApiUri = string.Concat(AppSettings.BaseApiUri, "/drinks/{0}"));
            }
        }
    }
}